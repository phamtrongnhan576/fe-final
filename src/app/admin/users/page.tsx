...
const UserPage = () => {
  ...
  const handleEdit = useCallback(
    async (user: User) => {
      ...
      if (userDetails) {
        ...
        const isValidDate = userDetails.birthday && dayjs(userDetails.birthday).isValid();
  ...
  const handleUpdateUser = useCallback(
    ...
    [avatarFile, selectedUser, updateUserMutation]
  );
      ...
      <div className="grid grid-cols-2 justify-between items-center mb-6">
        ...
        <div className="flex justify-end items-center space-x-4">
          ...
          <Button
            ...
            onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#e55e61")}
            onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#fe6b6e")}
          >
            Add User
          </Button>
        </div>
